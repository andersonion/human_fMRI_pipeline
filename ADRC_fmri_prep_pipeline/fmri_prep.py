...
fmri_command = f'singularity exec --bind /mnt/newStor:/mnt/newStor --bind /home/apps//ubuntu-22.04/anaconda3/ssl/:/home/apps//ubuntu-22.04/anaconda3/ssl/ {SID}/fmriprep-v25.0.0.sif fmriprep'
subj = (sys.argv[1])
